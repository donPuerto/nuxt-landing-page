          ...
          <FadeIn v-for="(testimonial, index) in testimonials" :key="index" direction="up" :delay="index * 100">
            <Card class="h-full">
              ...
              <div class="mt-auto">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ testimonial.role }}, {{ testimonial.company }}</p>
              </div>
            </Card>
          </FadeIn>
        </div>
      ...
      <Container>
        ...
        <FadeIn direction="up" :delay="200">
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            >
              <span class="text-lg font-semibold text-gray-700 dark:text-gray-300">{{ client }}</span>
            </div>
          </div>
        </FadeIn>
      </Container>
          ...
          <div class="mt-12 pt-12 border-t border-gray-200 dark:border-gray-800">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <a href="mailto:don.puerto.1003@gmail.com" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              ...
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-400">0976 093 8376</p>
              </div>
              <div>
                <div class="inline-flex items-center justify-center w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-lg mb-4">
                  <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
